...
class Merlin {
	...
	protected function license() {
        if(chakta_get_registered_purchase_code()) {
	...
	protected function plugins() {
        if(empty(chakta_get_registered_purchase_code())) {
            echo "<p>".esc_html__('Please verify the purchase code first.','chakta')."</p>";
	...
	public function _ajax_activate_license() {
		...
		update_option( 'envato_purchase_code_30127681', $license_key );

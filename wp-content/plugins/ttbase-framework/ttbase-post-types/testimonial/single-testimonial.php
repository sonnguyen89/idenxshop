    ...
    if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
        ...
        <div class="container">
            <div class="row">
			    <?php
			    //Service Sidebar
			    if ( is_active_sidebar('sidebar-testimonial') && rwmb_meta('gymx_post_content_sidebar', $post->ID ) != 'hide' ) { ?>
				    <div class="col-md-4">
				        <div class="testimonial-sidebar">
                    		<?php dynamic_sidebar( 'sidebar-testimonial' ); ?>
                    	</div>
            	    </div>
            	<?php }
            	 if (is_active_sidebar('sidebar-testimonial') && rwmb_meta('gymx_post_content_sidebar', $post->ID ) != 'hide') { ?>
            	...
            	<?php } ?>
            	    <div class="row">
                		<article id="post-<?php the_ID(); ?>" <?php post_class(array('col-sm-12','testimonial-content', 'clearfix')); ?>>

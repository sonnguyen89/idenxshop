...
if ( ! class_exists( 'WP_Importer_Logger' ) ) {
	require TTBASE_FRAMEWORK_PATH . 'ttbase-demo-importer/vendor/humanmade/WordPress-Importer/class-logger.php';
}
if ( ! class_exists( 'WP_Importer_Logger_CLI' ) ) {
	require TTBASE_FRAMEWORK_PATH . 'ttbase-demo-importer/vendor/humanmade/WordPress-Importer/class-logger-cli.php';
}

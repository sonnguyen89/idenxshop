...
// VC Events ------------------------------------------------------------------------ >
function ttbase_vc_event_grid_shortcode() {
		
	vc_map( array(
		'name'				=> esc_html__( 'TTBase Event Grid', 'ttbase-framework' ),
		'base'				=> 'ttbase_event_grid',
		'description'		=> esc_html__( 'Show your events in a grid style.', 'ttbase-framework' ),
		...
		'params'			=> array(
			...
			array(
				"type" => "textfield",
				"heading" => esc_html__("Number of Events", 'ttbase-framework'),
				"param_name" => "events",
				"value" => '6'
			),
			array(
...
add_action( 'vc_before_init', 'ttbase_vc_event_grid_shortcode' );
